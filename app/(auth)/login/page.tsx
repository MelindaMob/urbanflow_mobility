    ...
    <div>
      <div className="mb-8">
        ...
        <p className="text-sm text-neutral-500 mt-2 leading-relaxed">
          Connectez-vous pour reprendre vos trajets là où vous les avez laissés.
        </p>
      </div>
      ...
      <form action={handleSubmit} className="space-y-5">
        ...
        <div className="flex items-center justify-between pt-0.5">
          ...
          <span className="text-sm font-medium text-flow-blue cursor-default">
            Oublié ?
          </span>
        </div>
      ...
      <p className="mt-8 text-center text-sm text-neutral-600">
        ...
        <Link href="/signup" className="text-mobility-green font-semibold hover:underline">
          S&apos;inscrire
        </Link>
      </p>
    </div>
